function PopupModel({message = "Are you sure you want to delete this product?", desc, onSubmit, onClose}) {
            ...
            <div className="relative p-4 w-full max-w-md max-h-full">
                <div className="relative rounded-lg shadow-sm bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 text-center">
                        <svg className="mx-auto mb-4 w-12 h-12 text-gray-200" aria-hidden="true"
                        ...
                        <div className="mb-4">
                            ...
                            <small className="text-red-600">{desc}</small>
                        </div>
